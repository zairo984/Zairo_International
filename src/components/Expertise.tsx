...
const Expertise = () => {
  const expertise = [
    ...
    },
    {
      ...
      title: "Leather",
      description: "Our unique handcrafted leather products can be purchased from cords craft online shop.",
      link: "/leather",
    },
    {
      number: "03",
      ...
      description: "We provide web development, SEO, content writing and all types of digital marketing services.",
      link: "/marketing",
    },
    {
      number: "04",
      ...
      title: "Technology",
      description: "Zairo International provides Technical solutions through BPO Services online.",
      link: "/technology",
    },
  ]
      ...
      <div className="container mx-auto px-4 mb-16 text-center">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-gray-400 text-lg">
            We specialize in multiple domains, bringing innovation and excellence to every project we undertake.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
          {expertise.map((item, index) => (
            <div
              key={index}
              className="group bg-[#0c1525] rounded-xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-red-600/10 border border-gray-800 hover:border-red-600/30"
            >
              <div className="p-8 flex flex-col md:flex-row gap-6 relative">
                ...
                <div className="flex-grow">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-4 group-hover:text-red-600 transition-colors duration-300">
                    <a href={item.link} className="hover:underline decoration-2 underline-offset-4">
                      {item.title}
                    </a>
                  </h2>
