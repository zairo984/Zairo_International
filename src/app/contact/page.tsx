...
const ContactUs = () => {
      const contactData = {
        offices: [
          {
            city: "Kanpur",
            address: "117/N/70 3rd Floor Kakadeo Kanpur Uttar Pradesh, 208025",
            phone: "+91 9598023492",
        ...
        supportEmail: "hr@zairointernational.com",
        alternateEmail: "hr.zairointernational@gmail.com",
      };
  ...
  const socialLinks = [
    {
      name: "Facebook",
      icon: "facebook",
      url: "https://www.facebook.com/Zairointernational",
    },
    { name: "Instagram", icon: "instagram", url: "https://www.instagram.com/zairointernational/?hl=en" },
    { name: "LinkedIn", icon: "linkedin", url: "https://www.linkedin.com/company/zairointernational/posts/?feedView=all" },
  ];
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 order-2 lg:order-1">
                ...
                <div className="mb-8">
                  <p className="text-lg text-gray-700 mb-6">
                    Thank you for your interest in reaching out to us! We value
                    your feedback, inquiries, and suggestions. Our team is
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <a
                          href={`mailto:${contactData.alternateEmail}`}
                          className="text-blue-600 hover:underline"
                        >
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold">
                          {contactData.offices[selectedOffice].city} Office
                        </h4>
                        <p className="text-gray-700 mb-2">
                          {contactData.offices[selectedOffice].address}
                        </p>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <ol className="space-y-4">
                    <li className="flex">
                      ...
                      <div>
                        <p className="text-gray-700">
                          We&apos;ll review your message and route it to the
                          right department
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="flex">
                      ...
                      <div>
                        <p className="text-gray-700">
                          We&apos;ll work together to address your needs or
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="h-96 bg-gray-300 relative">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d223.20714269183364!2d80.29446993023157!3d26.477823860300116!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399c393b0d80423f%3A0x5a0054d06432272d!2sZairo%20International%20Private%20Limited!5e0!3m2!1sen!2sin!4v1778679797375!5m2!1sen!2sin"
                  width="100%"
                  height="450"
                  style={{ border: 0 }}
