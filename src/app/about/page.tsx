...
const About = () => {
	return (
		<div>
			<div className="h-[10rem] w-full opacity-55">
				<Image
					src={about}
					alt="about"
				...
				<div className="mt-12">
					<div>
						<div className="grid grid-cols-2 gap-6">
							...
							/>
							<div className="px-6 text-gray-400 text-xs">
								<h3 className="text-2xl font-semibold text-gray-800">
									OUR MISSION
								</h3>
								<p className=" text-gray-600 mt-4 tracking-wide leading-relaxed">
						...
						<div className="grid grid-cols-2 gap-6 mt-12 h-[20rem]">
                            ...
                            <Image
								src={ceo}
								alt="ceo"
								className="rounded-lg shadow-md h-full object-cover overflow-hidden"
							/>
						</div>
                        <div className="grid grid-cols-2 gap-6 mt-12 h-[20rem]">
                        <Image
								src={ceo}
								alt="ceo"
								className="rounded-lg shadow-md h-[50%] object-cover overflow-hidden"
							/>
							<div className="px-6 text-gray-400 text-xs">
								<h3 className="text-2xl font-semibold text-gray-800">
									OUR MISSION
								</h3>
								<ul  className=" text-gray-600 mt-4 tracking-wide leading-relaxed">
